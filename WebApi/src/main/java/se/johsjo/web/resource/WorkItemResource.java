...
public final class WorkItemResource {
	...
	@POST
	@Path("{id}/issues")
	public Response addIssueToWorkItem(@PathParam("id") String id, String issueDescription) {
		Long longId = Long.parseLong(id);
		WorkItem workItem = workItemService.getWorkItemById(longId);
		Issue issue;
		if (workItem == null) {
	...
	@PUT
	@Path("{id}")
	public Response updateWorkItem(@PathParam("id") String id, WorkItem workItem) throws ServiceException {
		Long longId = Long.parseLong(id);
		if (workItem.getId() != longId) {
	...
	public Response updateIssue(@PathParam("id") String id, @PathParam("issueId") Long issueId, Issue issue) {
		Long longId = Long.parseLong(id);
		WorkItem workItem = workItemService.getWorkItemById(longId);
